...
- cluster:
  ...
  name: eks_zemax-eks-TNajBRIF

contexts:
- context:
    cluster: eks_zemax-eks-TNajBRIF
    user: eks_zemax-eks-TNajBRIF
  name: eks_zemax-eks-TNajBRIF

current-context: eks_zemax-eks-TNajBRIF
...
```shell
$ aws eks --region us-west-2 update-kubeconfig --name zemax-eks-sR8eLIil
```
